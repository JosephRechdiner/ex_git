...
@employees_routes.get("/employees", response_model=List[EmployeeResponse])
def employees():
    return db.get_all_employees()

@employees_routes.get("/employees/{emp_id}", response_model=EmployeeResponse)
